...
```text
ค่าแสดงออกมาตามที่ได้รันโปรแกรมไป
...
```
![](image/11.PNG)
สามารถสร้างใหม่ Professor ได้เพราะเป็นคลาสแม่จึงสามารถเข้าถึงคลาสลูกได้
### ข้อ 2.
...
```
เกิดการ error คลาส Student ไม่สามารถสร้างใหม่ Professor ได้เพราะ Class Student ไม่ได้มี คลาส Professor เป็นคลาสลูก
### ข้อ 3.
